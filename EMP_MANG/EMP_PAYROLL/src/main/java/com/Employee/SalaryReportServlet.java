...
public class SalaryReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        out.println("<style>");
        out.println("body{margin:0;font-family:Arial;");
        ...
        out.println("border-radius:6px;text-decoration:none;color:white;font-size:14px;}");
        ...
        try {
            ...
            // 🔥 VERY IMPORTANT (fixes blank page)
